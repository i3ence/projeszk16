...
public final class Core {
    ...
    /**
     * Adds a new player to the game. It adds to the clients hashmap of the core
     * and to the map.
     *
    ...
    /**
     * Sends the actual state of the game and the status of the player itself to
     * every player in a form of simplified map objects. If a client cannot be
     * reached it gets removed from the server.
     *
     * @param simpleMapObjects a SimpleMapObjects object which contains only the
     * information the players need.
