...
public class ClientHandler extends Thread {
    ...
    /**
     * Initializes the components which needed for the communication with the
     * client.
     *
     ...
     *
     * @param alive The boolean which determines if the connection is alive with
     * the client.
     */
    ...
    /**
     * The main method of this class. The communication with the individual
     * clients are made here. If a player can join the client gets a
     * JoinResponse object with the status of STATUS_JOIN_ACCEPTED, the id of
     * the player and the size of the map. Then the client sends it's name and
     * the player is added to the game. Until the client quits the game the
     * server continously listening for the Request objects which contains the
     * player's cursor's data to move. If the server is full the JoinResponse
     * object with the status of STATUS_JOIN_REJECTED send back and the
    ...
    /**
     * Sends the actual state of the game to the client. The status represents
     ...
     * @throws IOException
     */
    public void sendMapData(List<MapObject> mapObjects) throws IOException, InterruptedException {
